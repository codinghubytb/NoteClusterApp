...
@dso_cache = dso_local local_unnamed_addr global [666 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		i64 63455406, ; hash 0x3c840ae, from name: libaot-LibraryComponent
		i8 0, ; bool ignore
	...
	%struct.DSOCacheEntry {
		i64 347176438, ; hash 0x14b17df6, from name: aot-NoteClusterWebApp.dll.so
		i8 0, ; bool ignore
	...
	%struct.DSOCacheEntry {
		i64 488244409, ; hash 0x1d1a04b9, from name: libaot-NoteClusterWebApp.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.9_name, ; name: libaot-NoteClusterWebApp.dll.so
		ptr null; void* handle (0x0)
	}, ; 67
	...
	%struct.DSOCacheEntry {
		i64 726898331, ; hash 0x2b53969b, from name: libaot-LibraryComponent.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-LibraryComponent.dll.so
		ptr null; void* handle (0x0)
	}, ; 97
	...
	%struct.DSOCacheEntry {
		i64 816816279, ; hash 0x30afa097, from name: raryComponent.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-LibraryComponent.dll.so
		ptr null; void* handle (0x0)
	}, ; 111
	...
	%struct.DSOCacheEntry {
		i64 855100809, ; hash 0x32f7cd89, from name: NoteClusterWebApp
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.9_name, ; name: libaot-NoteClusterWebApp.dll.so
		ptr null; void* handle (0x0)
	}, ; 120
	...
	%struct.DSOCacheEntry {
		i64 1098562680, ; hash 0x417abc78, from name: aot-LibraryComponent
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-LibraryComponent.dll.so
		ptr null; void* handle (0x0)
	}, ; 156
	...
	%struct.DSOCacheEntry {
		i64 2309945537, ; hash 0x89aef8c1, from name: libaot-NoteClusterWebApp
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.9_name, ; name: libaot-NoteClusterWebApp.dll.so
		ptr null; void* handle (0x0)
	}, ; 352
	...
	%struct.DSOCacheEntry {
		i64 2525787775, ; hash 0x968c767f, from name: aot-NoteClusterWebApp
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.9_name, ; name: libaot-NoteClusterWebApp.dll.so
		ptr null; void* handle (0x0)
	}, ; 382
	...
	%struct.DSOCacheEntry {
		i64 3008689476, ; hash 0xb354f544, from name: raryComponent
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-LibraryComponent.dll.so
		ptr null; void* handle (0x0)
	}, ; 467
	...
	%struct.DSOCacheEntry {
		i64 3028576494, ; hash 0xb48468ee, from name: NoteClusterWebApp.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.9_name, ; name: libaot-NoteClusterWebApp.dll.so
		ptr null; void* handle (0x0)
	}, ; 474
	...
	%struct.DSOCacheEntry {
		i64 3848313649, ; hash 0xe5609b31, from name: LibraryComponent
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-LibraryComponent.dll.so
		ptr null; void* handle (0x0)
	}, ; 596
	...
	%struct.DSOCacheEntry {
		i64 3915642147, ; hash 0xe963f523, from name: LibraryComponent.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-LibraryComponent.dll.so
		ptr null; void* handle (0x0)
	}, ; 605
	...
	%struct.DSOCacheEntry {
		i64 4216335315, ; hash 0xfb502bd3, from name: aot-LibraryComponent.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-LibraryComponent.dll.so
		ptr null; void* handle (0x0)
	}, ; 654
